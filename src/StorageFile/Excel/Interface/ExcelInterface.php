...
namespace LaravelFile\StorageFile\Excel\Interface;

use LaravelFile\StorageFile\Interface\StorageFileInterface;

/**
 * Storage配下のExcelファイルを扱うクラスのInterface
 * 
 * @package LaravelFile\StorageFile\Excel\Interface
 */
interface ExcelInterface extends StorageFileInterface
{
    /*----------------------------------------*
     * Create 
     *----------------------------------------*/
